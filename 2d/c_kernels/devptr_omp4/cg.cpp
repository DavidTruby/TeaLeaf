...
#pragma omp target data use_device_ptr(p,r,u,density,energy,w,kx,ky)
  {
...
void cg_calc_w(
    ...
    double* ky)
{
#pragma omp target data use_device_ptr(w,p,kx,ky)
  {
...
void cg_calc_ur(
    ...
    double* w)
{
#pragma omp target data use_device_ptr(u,r,p,w)
  {
